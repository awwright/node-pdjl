...
function Item40(r, aaa0, aaaa, bbbb, cccc){
	return new Buffer([
		0x11, 0x87, 0x23, 0x49, 0xae, 0x11, 0x03, 0x80,
...
var SYMX = 0x24;
function Item41(r, aaaa, bbbb, cccc, dddd, label, eeee, symbol){
	...
	// ff = nothing
	var symb = symbol;
	var buf = new Buffer(0x62+label.length*2);
	buf.fill();
	var tpl = new Buffer([
		0x11, 0x87, 0x23, 0x49, 0xae, 0x11, 0x03, 0x80,
...
function handleDBServerConnection(device, socket) {
	...
	socket.on('data', function(newdata) {
		...
		if(data[0xe]==0x06 && data[0xf]==0x14){
			...
			var item1 = Item41(r, 1, 0x0c, 0x01, 0x10, "Embrace", 5, 6);
...
//				0x00, 0x00,
				...
				0x06, 0x02, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06,
				0x11, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00,
				0x00, 0x01, 0x11, 0x00, 0x00, 0x00, 0x10, 0x26,
				0x00, 0x00, 0x00, 0x08, 0x00, 0x45, 0x00, 0x6d,
				0x00, 0x62, 0x00, 0x72, 0x00, 0x61, 0x00, 0x63,
				0x00, 0x65, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,
				0x02, 0x26, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
				0x11, 0x00, 0x00, 0x00, SYMX, 0x11, 0x05, 0x00,
				...
				0x00, 0x65, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,
				0x02, 0x26, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
				0x11, 0x00, 0x00, 0x00, 0x02, 0x11, 0x00, 0x00,
				0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x11,
				0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,
				0x00, 0x11, 0x00, 0x00, 0x00, 0x00,
			...
			console.log(formatBuf(response_request.slice(0, item1.length+2)));
			console.log(formatBuf(item1));
