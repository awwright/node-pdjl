...
function handleDBServerConnection(device, socket) {
	...
	socket.on('data', function(newdata) {
		...
		if(type==0x30){
			...
			var item5 = Item41(r, 1, 0x0c, 0*100, 0x02, "", 0x26, 0x0d); // 0 for blank, centi-bpm otherwise
			var item6 = Item41(r, 1, 0x0c, 0*100, 0x02, "", 0x26, 0x0d);
			...
			console.log(formatBuf(item6));
			console.log(formatBuf(response_request.slice(0, item6.length+2)));
			//item6.copy(response_request);
