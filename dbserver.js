	...
	socket.on('data', function(newdata) {
		...
		if(type==0x30){
			...
			socket.write(Buffer.concat([
				Item40(r, 0x01, 0, 0x01, 0),
				Item41(r, 1, 0x0c, 0x01, 0x10, "ABCDEFG", 0x26, 0x04),
				Item41(r, 1, 0x0c, 0x01, 0x4c, "Armin van Buuren feat. Eric Vloeimans", 0x26, 0x07),
				Item41(r, 1, 0x0c, 0x01, 0x4c, "Embrace", 0x26, 0x02),
				Item41(r, 1, 0x0c, 9001, 0x02, "", 0x26, 0x0b),
				Item41(r, 1, 0x0c, 0*100, 0x02, "", 0x26, 0x0d), // 0 for blank, centi-bpm otherwise
