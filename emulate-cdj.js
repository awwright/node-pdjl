...
net.createServer(function(socket) {
	...
	socket.on('data', function(data) {
		...
		// Second packet? What does this do?
		...
		var incoming_hello_2b = new Buffer([0x11, 0x87, 0x23, 0x49, 0xae, 0x11, 0x03, 0x80 ]);
		if(data.slice(0,8).compare(incoming_hello_2b)==0 && data[0xe]==0x02 && data[0xf]==0x14){
